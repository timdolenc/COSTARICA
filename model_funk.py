...
@st.cache_data
def stroški_amortizacije_po_času(dnevi, začetna_inv, amortizacijska_stopnja):
    amortizacija = začetna_inv * amortizacijska_stopnja ** (dnevi/365)
    return amortizacija

dnevi = np.arange(1, 365)
print(stroški_amortizacije_po_času(dnevi, 100, 0.1))
